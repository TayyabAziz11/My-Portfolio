...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-slate-100 dark:from-slate-900 dark:to-slate-800 transition-all duration-500">
      ...
      {/* Main Hero Content */}
      <main className="container mx-auto px-4 flex-1 flex flex-col lg:flex-row items-center justify-between py-12">
        {/* Left Column */}
        <div className="w-full lg:w-1/2 flex">
          ...
          <div className="text-center lg:text-left">
            <div className="relative mb-4">
              <h1 className={`text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white transition-opacity duration-300 ${
        ...
        <div className={`w-full lg:w-1/2 flex justify-center mt-8 lg:mt-0 transform transition-all duration-500 ${
